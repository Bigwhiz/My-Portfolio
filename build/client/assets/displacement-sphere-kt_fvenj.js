import{r,j as y}from"./jsx-runtime-BgQc5Su6.js";import{u as R}from"./theme-provider-iTxONrHh.js";import{u as L,g as z,T as M}from"./heading-DFWC3-0l.js";import{u as C}from"./image-DeBoGKLP.js";import{u as E}from"./useWindowSize-D2B5biJg.js";import{V as I,W as j,L as q,e as A,S as D,f as G,U as V,g as F,M as T,c as U,a as k,D as H,A as W,r as N}from"./three-BzMM05cl.js";import{t as B}from"./throttle-BgiUmwhn.js";import{u as P}from"./use-spring-Diupg0CB.js";import"./components-zDhStzPH.js";import"./index-BegcTpmo.js";const O=`#define PHONG\r
\r
...
`,Y="_canvas_1pqfq_1",J={canvas:Y},h={stiffness:30,damping:20,mass:2},an=w=>{const{theme:u}=R(),b=r.useRef(Date.now()),m=r.useRef(),S=r.useRef(),c=r.useRef(),o=r.useRef(),a=r.useRef(),d=r.useRef(),g=r.useRef(),p=r.useRef(),x=r.useRef(),t=r.useRef(),s=L(),l=C(m),_=E(),f=P(0,h),v=P(0,h);return r.useEffect(()=>{const{innerWidth:n,innerHeight:e}=window;return S.current=new I(.8,.5),c.current=new j({canvas:m.current,antialias:!1,alpha:!0,powerPreference:"high-performance",failIfMajorPerformanceCaveat:!0}),c.current.setSize(n,e),c.current.setPixelRatio(1),c.current.outputColorSpace=q,o.current=new A(54,n/e,.1,100),o.current.position.z=52,a.current=new D,p.current=new G,p.current.onBeforeCompile=i=>{g.current=V.merge([i.uniforms,{time:{type:"f",value:0}}]),i.uniforms=g.current,i.vertexShader=X,i.fragmentShader=O},r.startTransition(()=>{x.current=new F(32,128,128),t.current=new T(x.current,p.current),t.current.position.z=0,t.current.modifier=Math.random(),a.current.add(t.current)}),()=>{U(a.current),k(c.current)}},[]),r.useEffect(()=>{const n=new H(16777215,u==="light"?1.8:2),e=new W(16777215,u==="light"?2.7:.4);return n.position.z=200,n.position.x=100,n.position.y=100,d.current=[n,e],d.current.forEach(i=>a.current.add(i)),()=>{N(d.current)}},[u]),r.useEffect(()=>{const{width:n,height:e}=_,i=e+e*.3;c.current.setSize(n,i),o.current.aspect=n/i,o.current.updateProjectionMatrix(),s&&c.current.render(a.current,o.current),n<=z.mobile?(t.current.position.x=14,t.current.position.y=10):n<=z.tablet?(t.current.position.x=18,t.current.position.y=14):(t.current.position.x=22,t.current.position.y=16)},[s,_]),r.useEffect(()=>{const n=B(e=>{const i={x:e.clientX/window.innerWidth,y:e.clientY/window.innerHeight};f.set(i.y/2),v.set(i.x/2)},100);return!s&&l&&window.addEventListener("mousemove",n),()=>{window.removeEventListener("mousemove",n)}},[l,s,f,v]),r.useEffect(()=>{let n;const e=()=>{n=requestAnimationFrame(e),g.current!==void 0&&(g.current.time.value=5e-5*(Date.now()-b.current)),t.current.rotation.z+=.001,t.current.rotation.x=f.get(),t.current.rotation.y=v.get(),c.current.render(a.current,o.current)};return!s&&l?e():c.current.render(a.current,o.current),()=>{cancelAnimationFrame(n)}},[l,s,f,v]),y.jsx(M,{in:!0,timeout:3e3,nodeRef:m,children:({visible:n,nodeRef:e})=>y.jsx("canvas",{"aria-hidden":!0,className:J.canvas,"data-visible":n,ref:e,...w})})};export{an as DisplacementSphere};
